...
urlpatterns = [
    ...
    path('djangoapp/fetchDealers/', views.api_get_dealers, name='api_get_dealers'),
    path('djangoapp/fetchDealers/<str:state>', views.api_get_dealers_by_state, name='api_get_dealers_by_state'),
    path('djangoapp/fetchDealer/<int:dealer_id>', views.api_get_dealer_by_id, name='api_get_dealer_by_id'),
    path('djangoapp/fetchReviews/dealer/<int:dealer_id>', views.api_get_reviews_by_dealer, name='api_get_reviews_by_dealer'),
